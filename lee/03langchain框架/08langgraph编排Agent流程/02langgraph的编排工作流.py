...
# --------------------------------------------
# @FilePath    : lee\03langchain框架\08langgraph编排Agent流程\02langgraph的编排工作流.py
# @Author      : Lee大侠
# @Desc        : 这是一个AI测试项目
...
class Agent:
    ...
    def create_agent(self):
        ...
        graph.add_conditional_edges("模型调用节点", self.router_func,["工具调用节点", "输出结果节点"])
...
if __name__ == '__main__':
    ...
    with open('graph.png', 'wb') as f:
        content = agent.get_graph().draw_mermaid_png()
        f.write(content)